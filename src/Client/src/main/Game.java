...
public class Game extends Canvas implements Runnable {
    ...
    //window dimensions
    public static final Integer WIDTH = 1300;
    ...
    public void run() {
        ...
        /*SerialPortEventListener listener = new SerialPortEventListener() {
            ...
            public void serialEvent(SerialPortEvent serialPortEvent) {
                try {
                    data = ino.printMessage();
                    if(Objects.equals(data, "Derecha")) {
                        p.directionSwap();
                    ...
                    if(Objects.equals(data, "Izquierda")) {
                        p.directionSwap();
    ...
    //CharacterCreator and Pac Man tick methods. Controls the movement
